...
export class FuseNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    ...
    {    
        ...
        // This prevents the item that is clicked to collapse if it has children
        if (this.hasChildrenOf(this.item))
        {
            return;
        }
    ...
    /**
     * Check if the given item has children
     *
     * @param parent
     * @param item
     * @returns {boolean}
